...
user.friend = {name:"Kramer", age: 40, location:"New York City", purchased: []}
...
updateUser = () => {
  ...
  var person
  oldAndLoud = (person) => {
    if (person.name == user.name || user.friend.name) {
      person.name.toUpperCase()
    }
    else if (person.age == user.age || user.friend.age) {
      ++person.age
    }
